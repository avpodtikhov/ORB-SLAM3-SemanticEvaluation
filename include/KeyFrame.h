...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        std::map<long unsigned int,KeyFrame*> GetChilds();
        KeyFrame *GetParent();
        ...
        std::map<long unsigned int,KeyFrame*> GetLoopEdges();

        // Merge Edges
        void AddMergeEdge(KeyFrame *pKF);
        std::map<long unsigned int,KeyFrame*> GetMergeEdges();

        // MapPoint observation functions
        int GetNumberMPs();
        MapPoint* CreateMapPoint(const Eigen::Vector3f& worldPos, const unsigned long int& projIndex);
        void AddMapPoint(MapPoint *pMP, const size_t &idx);
        void EraseMapPointMatch(const int &idx);
        void EraseMapPointMatch(MapPoint *pMP);
        void ReplaceMapPointMatch(const int &idx, MapPoint *pMP);
        std::map<unsigned long int ,MapPoint*> GetMapPoints();
        ...
        void PreSave(std::map<long unsigned int,KeyFrame*> &spKF, std::map<long unsigned int,MapPoint*> &spMP, set<GeometricCamera *> &spCam);
    ...
    protected:
        ...
        std::map<long unsigned int, KeyFrame*> mConnectedKeyFrames;
        std::map<long unsigned int,int> mConnectedKeyFrameWeights;
        ...
        KeyFrame *mpParent;
        std::map<long unsigned int,KeyFrame*> mspChildrens;
        std::map<long unsigned int,KeyFrame*> mspLoopEdges;
        std::map<long unsigned int,KeyFrame*> mspMergeEdges;
        // For save relation without pointer, this is necessary for save/load function
