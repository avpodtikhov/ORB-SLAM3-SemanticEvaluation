...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        KeyFrame* keyframe{};
        map<long unsigned int,KeyFrame*> connections{};
        LoopConnections() = default;
        LoopConnections(const long unsigned int & keyframeId, KeyFrame* keyframe, const map<long unsigned int,KeyFrame*>& connections);
    };
    ...
    {
    public:
        typedef pair<map<unsigned long int,KeyFrame*>,int> ConsistentGroup;
//        typedef map<KeyFrame *, g2o::Sim3, std::less<KeyFrame *>,
//                    Eigen::aligned_allocator<std::pair<KeyFrame *const, g2o::Sim3>>>
//            KeyFrameAndPose;
        typedef map<unsigned long int,pair<KeyFrame* ,g2o::Sim3>,std::less<>,
                Eigen::aligned_allocator<std::pair<unsigned long int const , pair<KeyFrame* ,g2o::Sim3>>>>KeyFrameAndPose;
    public:
    ...
    protected:
        ...
        void CheckObservations(map<unsigned long, KeyFrame *> &spKFsMap1, map<unsigned long, KeyFrame *> &spKFsMap2);
