...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        void static LocalBundleAdjustmentWithLines(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int &num_fixedKF, int &num_OptKF, int &num_MPs, int &num_edges);
        ...
        void static OptimizeEssentialGraph(Map *pMap, KeyFrame *pLoopKF, KeyFrame *pCurKF,
                                           ...
                                           map<unsigned long int, LoopConnections> &loopConnection,
