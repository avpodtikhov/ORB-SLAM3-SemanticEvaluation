...
namespace ORB_SLAM3
{
    ...
    void Settings::readSemanticParams(cv::FileStorage &fSettings)
    {
        bool found;

        mbDropMoving = readParameter<bool>(fSettings, "Semantic.DropMoving", found, false);
        mbDropDynamic = readParameter<bool>(fSettings, "Semantic.DropDynamic", found, false);
